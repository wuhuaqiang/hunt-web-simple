...
public class SysRoleOrganizationServiceImpl implements SysRoleOrganizationService {
    ...
    @Override
    public boolean isExistName(String name, Integer parentId) {
        return roleOrganizationMapper.isExistName(name, parentId);
    }

    @Override
    public Integer insertRoleOrganization(SysRoleOrganization roleOrganization) {
        Integer id = roleOrganizationMapper.insert(roleOrganization);
        return id;
    }

    @Override
    public boolean isExistNameExcludeId(Integer id, String name, Integer parentId) {
    ...
    @Override
    public SysRoleOrganization selectRoleOrganizationById(Integer id) {
        return roleOrganizationMapper.selectById(id);
    }

    @Override
    public PageInfo selectPage(int page, int rows, Integer id) {
