...
public class SysOrganizationServiceImpl implements SysOrganizationService {
    ...
    @Override
    public Integer insertOrganization(SysOrganization sysOrganization) {
        Integer i = sysOrganizationMapper.insert(sysOrganization);
        return i;
    }
    ...
    @Override
    public PageInfo selectPage(int page, int row, Integer id) {
    ...
    @Override
    public SysOrganization selectOrganization(Integer id) {
        SysOrganization sysOrganization = sysOrganizationMapper.selectById(id);
        return sysOrganization;
    }

    @Override
    public boolean isExistFullNameExcludeId(Integer id, String fullName) {
