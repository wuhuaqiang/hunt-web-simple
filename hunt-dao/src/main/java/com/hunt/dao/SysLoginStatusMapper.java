...
public interface SysLoginStatusMapper {
    ...
    SysLoginStatus selectByUserIdAndPlatform(@Param("userId") Integer userId, @Param("platform") int platform);

    List<SysLoginStatus> selectByUserId(@Param("userId") Integer userId);
}